...
// Import images
import KiboCarImg from '@/assets/product/kibokits/kibo18kit/kibocostume-dancers2-600x416.jpg';
import KiboBinsImg from '@/assets/product/kibokits/kibo18kit/KIBO-bin-300x201.jpg';
import KiboMainImg from '@/assets/product/kibokits/kibo18kit/KIBO-18-package-600x399.jpeg';
...
const Kibo18Kit = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '3');
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "KIBO 18 Kit added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '3');
    return product ? `$${product.price.toFixed(2)}` : '$450.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO 18 Kit</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO 18 Kit</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> KIBO18Kit</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  The KIBO 18 kit builds upon the art platforms, sensors and outputs of the KIBO 15 Kit, <strong>adding advanced sensors – the Eye and Telescope – and If/End If conditional programming</strong> with additional parameters.
                </p>
                
                <p className="text-gray-700 mb-4">
                  <strong>The KIBO 18 Robot Kit Contains:</strong>
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>1 KIBO Robot with 18 Programming Blocks</li>
                ...
                <p className="text-gray-700">
                  The plastic bin that comes with KIBO 18 is designed for easy cleanup and sturdy storage in classroom environments.
                </p>
              </div>
            )}
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">6.3 lbs</td>
                      </tr>
                      <tr>
