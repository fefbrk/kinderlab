...
// Import new images
import KiboCarImg from '@/assets/product/kibokits/kibo10kit/KIBO-car.jpg';
import KiboBinsImg from '@/assets/product/kibokits/kibo10kit/KIBO-10-Bins-scaled-600x337.jpg';
import KiboMainImg from '@/assets/product/kibokits/kibo10kit/KIBO-120519_9365.jpg';
...
const Kibo10Kit = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '1');
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "KIBO 10 Kit added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '1');
    return product ? `$${product.price.toFixed(2)}` : '$310.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO 10 Kit</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO 10 Kit</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> KIBO10Kit</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  KIBO 10 is a hands on, screen-free robot kit where PreK-5th graders create, 
                  design, decorate and bring their own robot to life! The KIBO 10 kit offers 
                  everything a child needs for an <strong>introduction to programming and 
                  movement with robotics</strong>.
                </p>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>1 KIBO Robot with 10 Programming Blocks</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">3.4 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">14 × 9 × 6 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
