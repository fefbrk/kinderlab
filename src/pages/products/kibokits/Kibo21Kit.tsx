...
// Import new images
import KiboCarImg from '@/assets/product/kibokits/kibo21kit/Bear-Hunt-Girls-600x343.jpg';
import KiboBinsImg from '@/assets/product/kibokits/kibo21kit/KIBO-bin-300x201.jpg';
import KiboMainImg from '@/assets/product/kibokits/kibo21kit/KIBO-120519_9358.jpg';
import KiboWhaleImg from '@/assets/product/kibokits/kibo21kit/Migrating-whale-KIBO-600x456.webp';
...
const Kibo21Kit = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '4');
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "KIBO 21 Kit added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '4');
    return product ? `$${product.price.toFixed(2)}` : '$550.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <Link to="/shop/kibo-kits" className="hover:text-kibo-purple transition-colors">KIBO Kits</Link>
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO 21 Kit</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO 21 Kit</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> KIBO21Kit</div>
              <div><span className="font-medium">Category:</span> <Link to="/shop/kibo-kits" className="text-purple-600 hover:underline">KIBO Kits</Link></div>
            </div>
          </div>
        </div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Our most complete kit!  KIBO 21 builds upon the advanced sensors and conditional programming of the KIBO 18 Kit, <strong>adding visual and audio narratives with the Expression Module and the Sound Record/Playback Module</strong>.
                </p>
                
                <p className="text-gray-700 mb-4">
                  <strong>The KIBO 21 Robot Kit Contains:</strong>
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>1 KIBO robot with 21 programming blocks</li>
                  <li>12 Parameter Cards</li>
                  <li>3 Motors</li>
                  <li>2 Wheels</li>
                  <li>3 Sensor Modules – Light, Sound and Distance</li>
                  <li>1 Lightbulb Module</li>
                  <li>1 Expression Module</li>
                  <li>1 Sound Record and Playback Module</li>
                  <li>Art Stages:
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                      <li>1 Stage Support</li>
                      <li>1 Stage Pedestal</li>
                      <li>1 Rectangular Stage Platform</li>
                      <li>1 Round Stage Platform</li>
                    </ul>
                  </li>
                </ul>
                
                <p className="text-gray-700">
                  The plastic bin that comes with KIBO 21 is designed for easy cleanup and sturdy storage in classroom environments.
                </p>
              </div>
            )}
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">6.6 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">12 × 17 × 8 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
