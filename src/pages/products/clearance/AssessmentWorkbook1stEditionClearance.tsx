...
// Import images
import MainImg from '@/assets/product/clearance/assessmentworkbook1stedition-clearance/Assessment-Packs-600x776.jpeg';

const AssessmentWorkbook1stEditionClearance = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Assessment Workbook 1st Edition (Clearance) added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '602');
    return product ? `$${product.price.toFixed(2)}` : '$7.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Assessment Workbook 1st Edition (Clearance)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Assessment Workbook 1st Edition (Clearance)"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Assessment Workbook 1st Edition (Clearance)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-ASSESSMENT-WORKBOOK-1ST-CLEARANCE</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                These Assessment Workbooks help teachers evaluate student learning with KIBO with a focus on programming and robotics concepts and the engineering design process. These assessments, in the form of fun story problems, help teachers address student learning and outcomes. We ecommended one workbook per student.
                </p>
                
                <p className="text-gray-700 mb-4">
                 These clearance items are our remaining stock of the 1st Edition of the assessment workbooks. The second edition introduced easy-to-use pre-cut sticker sheets.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Assessment Workbook 1st Edition (Clearance) - Enlarged"
...
export default AssessmentWorkbook1stEditionClearance;