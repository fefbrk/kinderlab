...
// Import images
import MainImg from '@/assets/product/clearance/expressyourself-clearance/Express-Yourself-Cover.jpg';
import Img2 from '@/assets/product/clearance/expressyourself-clearance/Expression-Module.jpeg';
import Img3 from '@/assets/product/clearance/expressyourself-clearance/KIBO-Drive-In-rotated-600x450.jpg';

const ExpressYourselfClearance = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '604');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '604');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Express Yourself! (Clearance) added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Express Yourself! (Clearance)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Express Yourself! (Clearance)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Express Yourself view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Express Yourself! (Clearance)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-EXPRESS-YOURSELF-CLEARANCE</div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Express Yourself! (Clearance) - Enlarged"
...
export default ExpressYourselfClearance;