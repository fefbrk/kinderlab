...
// Import images
import MainImg from '@/assets/product/clearance/makelearningvisible-clearance/Make-Learning.jpg';
import Img2 from '@/assets/product/clearance/makelearningvisible-clearance/Marker-Extension-Set-600x400.jpeg';
import Img3 from '@/assets/product/clearance/makelearningvisible-clearance/MES-Draw-Circles-1-600x337.jpg';

const MakeLearningVisibleClearance = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '605');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '605');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Make Learning Visible! (Clearance) added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Make Learning Visible! (Clearance)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Make Learning Visible! (Clearance)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Make Learning Visible view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Make Learning Visible! (Clearance)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-MAKE-LEARNING-VISIBLE-CLEARANCE</div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Make Learning Visible! (Clearance) - Enlarged"
...
export default MakeLearningVisibleClearance;