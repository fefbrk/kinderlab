...
// Import images
import MainImg from '@/assets/product/clearance/builditbetter-clearance/Build-it-Better-Cover.jpg';
import Img2 from '@/assets/product/clearance/builditbetter-clearance/KIBO-120519_9261-600x400.jpg';
import Img3 from '@/assets/product/clearance/builditbetter-clearance/Lego-Masterpiece.jpeg';

const BuildItBetterClearance = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '603');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '603');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Build It Better! (Clearance) added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Build It Better! (Clearance)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Build It Better view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Build It Better! (Clearance)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-BUILD-IT-BETTER-CLEARANCE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 The Build It Better! Curriculum Guide provides up to 10 hours of  KIBO activities based on the Building Brick Extension Set. This research-based curriculum booklet supports the KIBO Building Brick Extension Set with engineering and architecture connections.
                </p>
                
                <p className="text-gray-700 mb-4">
               With this guide, students will:
                </p>
                
                <p className="text-gray-700 mb-4">
                  The Build It Better! curriculum guide includes:
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Build onto KIBO with LEGO® compatible building bricks to create and program robotic pets;</li>
                  <li>Build dream houses</li>
                  <li>Invent their own solutions to problems in favorite storybooks.</li>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Build It Better! (Clearance) - Enlarged"
...
export default BuildItBetterClearance;