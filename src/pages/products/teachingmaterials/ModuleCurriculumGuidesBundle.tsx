...
import MainImg from '@/assets/product/teachingmaterials/modulecurriculum/new-curriculum-guides-600x385.webp';
import ExpressionModuleImg from '@/assets/product/teachingmaterials/modulecurriculum/Expression-Module.jpeg';
import LegoMasterpieceImg from '@/assets/product/teachingmaterials/modulecurriculum/Lego-Masterpiece.jpeg';
import MarketExtensionImg from '@/assets/product/teachingmaterials/modulecurriculum/Market-Extension-Set-Drawing.jpg';

const ModuleCurriculumGuidesBundle = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '415');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '415');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Module Curriculum Guides Bundle added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '415');
    return product ? `$${product.price.toFixed(2)}` : '$105.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Module Curriculum Guides Bundle</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Module Curriculum Guides Bundle"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Module Curriculum Guides Bundle view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Module Curriculum Guides Bundle</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-MODULE-GUIDES-BUNDLE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Build It Better!, supports the Building Brick Extension Set</li>
                  <li>Make Learning Visible!, supports the Marker Extension Set</li>
                  <li>Express Yourself!, supports the Expression Module</li>
                  <li>Showtime with KIBO!, supports the Sound Record/Playback Module</li>
              This bundle represents a 25% discount off the individual guide prices.
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Module Curriculum Guides Bundle - Enlarged"
...
export default ModuleCurriculumGuidesBundle;