...
// Import images
import MainImg from '@/assets/product/teachingmaterials/kiboactivitycards/Activity-Cards-front-and-back-import-600x467.webp';
import KiboActivityCardsImg from '@/assets/product/teachingmaterials/kiboactivitycards/KIBO-Activity-Cards.webp';

const KiboActivityCards = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '406');
  const quantity = productInCart ? productInCart.quantity : 0;

  const images = [
    MainImg,
    KiboActivityCardsImg
  ];

  const handleAddToCart = () => {
    const product = products.find(p => p.id === '406');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "KIBO Activity Cards added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '406');
    return product ? `$${product.price.toFixed(2)}` : '$36.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO Activity Cards</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`KIBO Activity Cards view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO Activity Cards</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-ACTIVITY-CARDS</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 The KIBO Activity Cards provide 15 creative KIBO activities with big, colorful images and easy-to-follow instructions, for hours of student engagement in the classroom or at home with KIBO!
                </p>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Design and build a “KIBO firetruck” and program it to drive around a cardboard town!</li>
                  <li>Decorate a “KIBO sunflower” that responds to light with actions the child designs!</li>
                  <li>Create a “KIBO rover” to navigate an imagined planet using its distance sensor!</li>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="KIBO Activity Cards - Enlarged"
...
export default KiboActivityCards;