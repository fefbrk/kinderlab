...
import MainImg from '@/assets/product/teachingmaterials/showtimewithkibo/showtime-with-KIBO.jpg';
import BoyExploringImg from '@/assets/product/teachingmaterials/showtimewithkibo/Boy-exploring-geography-rotated.jpg';
import KiboDancerImg from '@/assets/product/teachingmaterials/showtimewithkibo/KIBO-Dancer-from-Africa-scaled-600x800.jpeg';

const ShowtimeWithKiboGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '416');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '416');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Showtime With KIBO! Guide added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Showtime With KIBO! (Sound Module Curriculum Guide)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Showtime With KIBO! (Sound Module Curriculum Guide)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Showtime With KIBO! Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Showtime With KIBO! (Sound Module Curriculum Guide)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-SHOWTIME-KIBO</div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Showtime With KIBO! Guide - Enlarged"
...
export default ShowtimeWithKiboGuide;