...
// Import images
import MainImg from '@/assets/product/teachingmaterials/assessmentworkbook/webstore-image-asseessment-workbook.webp';
import SecondImg from '@/assets/product/teachingmaterials/assessmentworkbook/Assessment-Workbook-600x776.webp';

const AssessmentWorkbook = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '409');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '409');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Assessment Workbook added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Assessment Workbook</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Assessment Workbook view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Assessment Workbook</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-ASSESSMENT</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 Our KIBO Assessment Workbooks, 2nd Ed., help teachers evaluate student learning with KIBO with a focus on programming and robotics concepts and the engineering design process. These assessments, in the form of fun story problems that children can solve with handy stickers, help teachers assess student learning and outcomes. (Recommended: one workbook per student.)
                </p>
                
                <p className="text-gray-700 mb-4">
                The Second Edition introduces pre-cut, peel-off KIBO block stickers for children to use when solving the programming challenges in the Workbook. These new sticker sheets make the assessments much easier to deliver in a busy classroom! And who doesn’t love stickers?
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.12 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Assessment Workbook - Enlarged"
...
export default AssessmentWorkbook;