...
// Import images
import MainImg from '@/assets/product/teachingmaterials/exploringwithkibo/241217_GwKv2-cover-v4d_ADV3-scaled.jpg';
import Image2 from '@/assets/product/teachingmaterials/exploringwithkibo/3-Girls-Scanning-600x338.jpg';
import Image3 from '@/assets/product/teachingmaterials/exploringwithkibo/Free-Throw.jpg';
import Image4 from '@/assets/product/teachingmaterials/exploringwithkibo/KIBO-Zoo-Animal.jpg';

const ExploringWithKIBO = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '402');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '402');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Exploring With KIBO added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '402');
    return product ? `$${product.price.toFixed(2)}` : '$84.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Exploring With KIBO</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Exploring With KIBO view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Exploring With KIBO - A Robotics Curriculum For Grades 3 - 5</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-EXPLORING</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                The second volume of KIBO’s Core Curriculum, Exploring with KIBO – A Robotics Curriculum for Grades 3-5, provides 60 hours of standards-alned lessons and activities specifically designed for upper elementary grades, with 20 hours of instruction per grade level. Serving as a direct follow-on to the foundational concepts found in the Growing with KIBO K-2 curriculum, Exploring with KIBO allows older children to expand their computational thinking and computer science skills utilizing KIBO’s playful extension sets and engaging cross-curricular activities.
                </p>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>More than 60 hours of comprehensive computer science instruction supported by easy-to-use programming cards, in addition to KIBO’s familiar wooden programming blocks</li>
                  <li>Standards-aligned, hands-on lessons and activities to support cross-curricular integration with math, science, social studies, and English Language Arts to build computational thinking and computer science skills</li>
               Exploring with KIBO leverages KinderLab’s extension sets to provide variety, engagement, and excitement for students as they work with KIBO for three additional years. The expanded curriculum enhances the KIBO STEAM Explorer Classroom package by incorporating advanced programming capabilities through the Building Brick Extension Set, Marker Extension Set, Free Throw Extension Set, and the Advanced Coding Extension Set.
                  ...
                  <p className="text-gray-700 mb-4">
                 Please note: Exploring with KIBO makes use of all of KIBO’s capabilities, including those enabled by KIBO’s various add-ons (including the four expansion sets identified above).  While some lessons can be run with the KIBO 18 and without extensions, you must have the KIBO 21 with all extensions to run Exploring with KIBO in its entirety.
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">1 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Exploring With KIBO - Enlarged"
...
export default ExploringWithKIBO;