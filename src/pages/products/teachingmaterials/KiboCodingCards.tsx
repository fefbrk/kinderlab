...
// Import images
import MainImg from '@/assets/product/teachingmaterials/kibocodingcards/KIBO-Coding-Card-Set.webp';

const KiboCodingCards = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '403');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '403');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "KIBO Coding Cards added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '403');
    return product ? `$${product.price.toFixed(2)}` : '$25.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO Coding Cards</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`KIBO Coding Cards view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO Coding Cards</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-CODING-CARDS</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  These KIBO Coding Cards are designed for older students who feel they have progressed beyond KIBO’s wooden blocks. This deck of KIBO Coding Cards provide an alternative for kids to develop their coding sequence. These cards work similarly to KIBO’s wooden blocks: each card is one command, and students sequence them and scan them with KIBO’s built in scanner. For older students, the cards may be more convenient and quicker to use than the wooden blocks, and they may feel more age-appropriate.
                </p>
                
                <p className="text-gray-700 mb-4">
                 These cards are included in the STEAM Explorer line of classroom packages, and are available for separate purchase.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="KIBO Coding Cards - Enlarged"
...
export default KiboCodingCards;