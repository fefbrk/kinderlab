...
import MainImg from '@/assets/product/teachingmaterials/makelearningvisible/Make-Learning.jpg';
import MarkerExtensionImg from '@/assets/product/teachingmaterials/makelearningvisible/Marker-Extension-Set-1-600x578.webp';

const MakeLearningVisibleGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '414');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '414');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Make Learning Visible! Guide added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Make Learning Visible! (Marker Curriculum Guide)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Make Learning Visible! (Marker Curriculum Guide)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Make Learning Visible! Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Make Learning Visible! (Marker Curriculum Guide)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-MAKE-LEARNING-VISIBLE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  The Make Learning Visible! curriculum guide provides up to 10 hours of KIBO activities based on KIBO’s Marker Extension Set. This research-based curriculum booklet supports the KIBO Marker Extension Set with engineering, mathematics, literacy, and art connections.
                </p>
                
                <p className="text-gray-700 mb-4">
                 Students will program KIBO to draw shapes and letters; create abstract artworks; and estimate distances by measuring the lines KIBO draws as it explores a cardboard town.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Make Learning Visible! Guide - Enlarged"
...
export default MakeLearningVisibleGuide;