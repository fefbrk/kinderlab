...
// Import images
import MainImg from '@/assets/product/teachingmaterials/creatingwithkibo/Creating-with-KIBO.jpg';

const CreatingWithKiboGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '405');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '405');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Creating With KIBO Curriculum Guide added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '405');
    return product ? `$${product.price.toFixed(2)}` : '$48.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Creating With KIBO Curriculum Guide</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Creating With KIBO Curriculum Guide"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Creating With KIBO Curriculum Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Creating With KIBO Curriculum Guide</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-CREATING</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                Get started with KIBO right away! Our comprehensive, research-based curriculum guide, Creating with KIBO, offers 20-40 hours of curriculum for PreK-2nd grade classrooms. Detailed lesson plans get teachers up and running quickly to introduce coding, robotics, and engineering concepts with KIBO.
                </p>
                
                <p className="text-gray-700 mb-4">
                An open-ended framework for a final project invites integration with other classroom projects. The STEM curriculum is aligned with Common Core standards, the CSK12 framework and state CS standards.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Creating With KIBO Curriculum Guide - Enlarged"
...
export default CreatingWithKiboGuide;