...
// Import images (updated to new categorized asset path)
import MainImg from '@/assets/product/teachingmaterials/kibosays/KIBO-Says.jpg';
import SecondImg from '@/assets/product/teachingmaterials/kibosays/kibo-says-600x452.jpg';
...
const KiboSaysGame = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '407');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '407');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "KIBO Says Game added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '407');
    return product ? `$${product.price.toFixed(2)}` : '$60.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO Says - Class Programming Game</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="KIBO Says - Class Programming Game"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`KIBO Says Game view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO Says - Class Programming Game</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-KIBO-SAYS</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                Let’s have some fun with the KIBO Says Programming Game! Learn KIBO’s coding language through engaging unplugged play! Our KIBO Says programming game is a collection of oversized cards (8.5″ square) with images of KIBO’s programming icons.
                </p>
                
                <p className="text-gray-700 mb-4">
                As they play “KIBO Says,” students learn KIBO’s programming language by acting out KIBO’s movements, sounds, and other commands themselves. KIBO can even scan the game cards, just like the blocks!
                </p>
                
                <p className="text-gray-700 mb-4">
                 The KIBO Says Game includes:
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>21 command cards (including the PLAY commands for the Sound Record/Playback Module)</li>
                  <li>12 parameter cards (for IF and REPEAT commands)</li>
                  <li>Instruction card for unplugged games</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.88 lbs</td>
                      </tr>
                      <tr>
