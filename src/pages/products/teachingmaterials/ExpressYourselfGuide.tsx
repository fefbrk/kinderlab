...
// Import images
import MainImg from '@/assets/product/teachingmaterials/expressyourself/Express-Yourself-Cover.jpg';
import ExpressionModuleImg from '@/assets/product/teachingmaterials/expressyourself/Expression-Module.jpeg';
import GeographyImg from '@/assets/product/teachingmaterials/expressyourself/Geography-and-Exploration-1-600x450.jpg';

const ExpressYourselfGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '413');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '413');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Express Yourself! Guide added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Express Yourself! (Expression Module Curriculum Guide)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Express Yourself! (Expression Module Curriculum Guide)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Express Yourself! Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Express Yourself! (Expression Module Curriculum Guide)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-EXPRESS-YOURSELF</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
               ...
               The Express Yourself! curriculum guide provides up to 10 hours of KIBO activities based on the KIBO’s Expression Module. This research-based curriculum booklet supports the KIBO Expression Module with art, literacy, and social studies connections.
                </p>
                
                <p className="text-gray-700 mb-4">
                 Students will create interactive book reports with the whiteboard; explore other countries and decorate their flags for a robotic world parade; and create interactive self-portraits.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Express Yourself! Guide - Enlarged"
...
export default ExpressYourselfGuide;