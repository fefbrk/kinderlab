...
// Import images
import MainImg from '@/assets/product/teachingmaterials/askandimagine/Ask-and-Imagine-Curriculum.jpg';
import RacetrackImg from '@/assets/product/teachingmaterials/askandimagine/ACES-Random-Racetrack-1-scaled-600x450.jpg';
import AdvancedCodingImg from '@/assets/product/teachingmaterials/askandimagine/Advanced-Coding-600x400.jpeg';

const AskAndImagineGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '602');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '602');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Ask and Imagine Guide added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '408');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Ask And Imagine (Advanced Coding Curriculum Guide)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Ask And Imagine (Advanced Coding Curriculum Guide)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Ask And Imagine Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Ask And Imagine (Advanced Coding Curriculum Guide)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-ASK-IMAGINE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Unlock Advanced Coding Concepts with KIBO! The Ask and Imagine Curriculum Guide provides 6 – 8 hours of KIBO activities based on the KIBO Advanced Coding Extension Set.
                </p>
                
                <p className="text-gray-700 mb-4">
                 For children who are experienced with KIBO’s core concepts, the Advanced Coding Extension Set offers the next step along a computer science pathway. With the new programming blocks, students can continue their exploration into even more sophisticated concepts:
                </p>
                
              
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Modularity and reusability with subroutines</li>
                  <li>Complex conditional behavior</li>
                  <li>Randomness</li>
                  In Ask and Imagine, students will design their own dance routines for KIBO, navigate KIBO along branching roads, and teach KIBO to play games.
                  ...
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">12 × 9 × 1 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Ask And Imagine Guide - Enlarged"
...
export default AskAndImagineGuide;