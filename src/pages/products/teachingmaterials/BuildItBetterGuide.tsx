...
// Import images
import MainImg from '@/assets/product/teachingmaterials/builditbetter/Build-it-Better-Cover.jpg';
import KiboImg from '@/assets/product/teachingmaterials/builditbetter/KIBO-120519_9261-600x400.jpg';
import LegoMasterpieceImg from '@/assets/product/teachingmaterials/builditbetter/Lego-Masterpiece-2-600x450.jpg';
import LegoSnowplowImg from '@/assets/product/teachingmaterials/builditbetter/Lego-Snowplow.jpg';

const BuildItBetterGuide = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '411');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '411');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Build It Better! Guide added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Build It Better! (Building Block Curriculum Guide)</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Build It Better! (Building Block Curriculum Guide)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Build It Better! Guide view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Build It Better! (Building Block Curriculum Guide)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-BUILD-BETTER</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  ...
                  <li>Invent their own structures to bring favorite storybooks to life</li>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Build It Better! Guide - Enlarged"
...
export default BuildItBetterGuide;