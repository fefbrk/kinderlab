...
// Import images
import MainImg from '@/assets/product/teachingmaterials/growingwithkibo/Growing-with-KIBO-Second-Printing-Cover.webp';

const GrowingWithKIBO = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '401');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '401');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Growing With KIBO added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Growing With KIBO</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Growing With KIBO view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Growing With KIBO - A Robotics Curriculum For Pre-K To 2nd Grade</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-GROWING</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  KIBO’s Core Curriculum, Growing with KIBO – A Robotics Curriculum for Pre-K to 2nd Grade, provides educators of young learners with 60 sequenced hours of standards-aligned lesson plans in robotics, coding, and computational thinking.
                </p>
                
                <p className="text-gray-700 mb-4">
                 This guide was designed to support early elementary classrooms with a complete, sequenced STEAM curriculum, not only covering robotics, coding, and computational thinking, but also providing opportunities for integrating these topics with arts and literacy activities.
                </p>
                
                <p className="text-gray-700 mb-4">
                Each level of this curriculum — Novice, Intermediate, and Advanced — contains 20 hours of classroom lesson plans (for a total of 60 hours), providing a complete PreK–2 robotics progression aligned to current and evolving computer science standards. Contextualized STEAM projects and a focus on social-emotional development allow students to develop digital fluency, as they collaborate, connect, and express themselves creatively.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Growing With KIBO - Enlarged"
...
export default GrowingWithKIBO;