...
// Import images
import MainImg from '@/assets/product/teachingmaterials/engineeringdesignjournals/Engineering-Design-Journal.jpg';

const EngineeringDesignJournals = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '412');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '412');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Engineering Design Journal added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Engineering Design Journals</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Engineering Design Journals"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Engineering Design Journal view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Engineering Design Journals</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-ENGINEERING-JOURNAL</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  An easy way to learning the engineering desgin process! With the Engineering Design Journal, students make their own learning visible by documenting their planning, revision, and testing. Students sketch their imagined constructions, plan their programs, and record the challenges and solutions they discover.
                </p>
                
                <p className="text-gray-700 mb-4">
                The Engineering Design Journal guides students through the Engineering Design Process while encouraging reflection and sharing. (Recommended: one journal per student.)
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.16 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Engineering Design Journals - Enlarged"
...
export default EngineeringDesignJournals;