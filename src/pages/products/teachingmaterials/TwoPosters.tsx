...
import MainImg from '@/assets/product/teachingmaterials/twoposters/poster-600x800.jpg';
...
const TwoPosters = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '418');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '418');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Two Posters added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '418');
    return product ? `$${product.price.toFixed(2)}` : '$30.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Two Posters - KIBO And Engineering Design Process</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Two Posters - KIBO And Engineering Design Process"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Two Posters - KIBO And Engineering Design Process</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TM-TWO-POSTERS</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                These two classroom posters help teachers introduce KIBO concepts:
                </p>
                
          
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>The “Meet KIBO” poster explains all of KIBO’s parts</li>
                  <li>The “Engineering Design Process” reminds the student of the steps to follow in their creative construction, revision, and sharing when using KIBO in any lesson or activity.</li>
