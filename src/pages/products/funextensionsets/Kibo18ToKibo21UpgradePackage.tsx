...
// Import images
import MainImg from '@/assets/product/funextensionsets/kibo18tokibo21upgrade/Upgrade-Package-600x400.jpeg';
import SoundRecorderImg from '@/assets/product/funextensionsets/kibo18tokibo21upgrade/Sound-recorder.jpeg';
import ExpressionModuleImg from '@/assets/product/funextensionsets/kibo18tokibo21upgrade/Expression-Module.jpeg';

const Kibo18ToKibo21UpgradePackage = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '207');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '207');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "KIBO 18 To KIBO 21 Upgrade Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '207');
    return product ? `$${product.price.toFixed(2)}` : '$149.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">KIBO 18 To KIBO 21 Upgrade Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="KIBO 18 To KIBO 21 Upgrade Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`KIBO 18 To KIBO 21 Upgrade Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">KIBO 18 To KIBO 21 Upgrade Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> K18K21UP207</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Do you have a KIBO 18 kit, but are interested in upgrading your kit to become a KIBO 21? Upgrade and save! Make your KIBO 18 a KIBO 21 with these additional features:
                </p>
                
                <p className="text-gray-700 mb-4">
                <strong>Sound Record Playback Module and Programming Blocks</strong> – Give KIBO a voice! Explore literacy and language development, bilingual education, music, and more! The set includes Sound Record/Playback Module and 3 Playback programming blocks for three different ways for children to record their own voice!
                </p>
                
               
                
                <p className="text-gray-700">
                  <strong>Expression Module</strong> – Supports a variety of literacy activities and allows children to express themselves, with the included KIBO Whiteboard, Dry-erase marker, Flagpole, and Spacer.
                </p>
              </div>
            )}
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="KIBO 18 To KIBO 21 Upgrade Package - Enlarged"
...
export default Kibo18ToKibo21UpgradePackage;