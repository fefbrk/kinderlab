...
// Import images
import MainImg from '@/assets/product/funextensionsets/freethrowextension/free-throw.jpeg';
import ArmImg from '@/assets/product/funextensionsets/freethrowextension/free-throw-Arm.jpeg';
import ConnectingImg from '@/assets/product/funextensionsets/freethrowextension/Connecting-Free-Throw-600x900.jpg';
import CatapultImg from '@/assets/product/funextensionsets/freethrowextension/kibo-catapult.webp';

const FreeThrowExtensionSet = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '206');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '206');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Free Throw Extension Set added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '206');
    return product ? `$${product.price.toFixed(2)}` : '$131.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Free Throw Extension Set</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Free Throw Extension Set view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Free Throw Extension Set</h1>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  <strong>Play and Toss with KIBO!</strong> With the KIBO Free Throw Extension Set, children experiment with forces, motion, and potential energy by programming KIBO to throw a ping pong ball!
                </p>
                
                <p className="text-gray-700 mb-4">
                  This is a wonderful tool to expand scientific inquiry with KIBO, as kids can explore physics concepts in a hands-on, intuitve way. Alter the trajectory, power, and leverage by changing the Free Throw options, and see how the throw changes as a result. Can you land your ping pong ball in the basket?
                </p>
                
                <p className="text-gray-700 mb-4">
                  <strong>The KIBO Free Throw Extension Set includes:</strong>
                </p>

                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>1 Free Throw</li>
                  <li>1 Throw Block</li>
                  <li>3 Compatible Ping-pong Balls (styles vary)</li>
                  <li>Rubber Bands</li>
               
                </ul>
                
                <p className="text-gray-700">
                  Notes: The Free Throw plugs into KIBO’s center motor socket.
                </p>
              </div>
            )}
                  ...
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">9 × 6 × 4 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Free Throw Extension Set - Enlarged"
...
export default FreeThrowExtensionSet;