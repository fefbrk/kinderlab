...
// Import images
import MainImg from '@/assets/product/funextensionsets/bundleoffunextension/KIBO_extras.jpg';
import CurriculumImg from '@/assets/product/funextensionsets/bundleoffunextension/bundle-of-fun-curriculum-guides-600x385-1-600x340.png';

const BundleOfFunExtensionPackage = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '204');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '204');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Bundle Of Fun Extension Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '204');
    return product ? `$${product.price.toFixed(2)}` : '$345.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Bundle Of Fun Extension Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Bundle Of Fun Extension Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Bundle Of Fun Extension Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Bundle Of Fun Extension Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BOFEP204</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Bundle all KIBO’s fun extension sets and save! The Bundle of Fun Extension Package includes our <strong>4 popular extension sets that enhance and extend the KIBO learning experience:</strong>
                </p>
                
            
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Advanced Coding Extension Set – Unlock advanced coding concepts with KIBO</li>
                  <li>Free Throw Extension Set – Play and toss with KIBO</li>
                  <li>Marker Extension Set – KIBO can draw</li>
                  <li>Building Brick Deluxe Extension Set – Build your KIBO up with building bricks</li>
              
                </ul>
                
                <p className="text-gray-700">
                  You can also can bundle KIBO’s fun extension sets along with their curriculum guides. This option includes 3 curriculum guides to support these fun extensions:
                </p>

                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Advanced Coding Extension Set’s Ask and Imagine Curriculum Guide</li>
                  <li>Marker Extension Set’s Make Learning Visible Curriculum Guide</li>
                  <li>Building Brick Extension Set’s Build it Better Curriculum Guide</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">4 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">17 × 12 × 8 in</td>
                      </tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Bundle Of Fun Extension Package - Enlarged"
...
export default BundleOfFunExtensionPackage;