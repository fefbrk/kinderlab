...
// Import images
import MainImg from '@/assets/product/funextensionsets/soundmodule/Sound-recorder.jpeg';
import KiboImg from '@/assets/product/funextensionsets/soundmodule/KIBO-120519_9288.jpg';

const SoundRecordPlaybackModule = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '211');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '211');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Sound Record/Playback Module added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '211');
    return product ? `$${product.price.toFixed(2)}` : '$99.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Sound Record/Playback Module</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Sound Record/Playback Module"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Sound Record/Playback Module view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Sound Record/Playback Module</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> SRPM211</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <strong>Give KIBO a voice!</strong> A child can record their own voice with the KIBO Sound Record/Playback Module – in three different ways! With this module, a student can expand role play and imagination with KIBO and use their own voice to explore literacy and language development, bilingual education, music, and more!
                </p>
                
                <p className="text-gray-700 mb-4">
                  <strong>The Module kit includes:</strong>
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Sound Record/Playback Module</li>
                  <li>Three Playback programming blocks</li>
                  <li>Complimentary USB cable for KIBO firmware update</li>
                The module plugs into one of KIBO’s module sockets. Using the three different buttons – triangle, circle, and square – kids can record three different short sound clips. Kids program KIBO to play back the sounds by adding one, two or three of the included command blocks in their programming sequence.
                </ul>
                
                <p className="text-gray-700">
                 <strong>Note:</strong> For KIBO robots sold prior to December 2016, you will have to install a one-time, free firmware update to use the Sound Record/Playback Module. The Module will come packaged with the USB cable required to connect KIBO to a Macintosh or Windows computer to install the firmware update.
                </p>
              </div>
            )}
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.44 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">4 × 4 × 4 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Sound Record/Playback Module - Enlarged"
...
export default SoundRecordPlaybackModule;