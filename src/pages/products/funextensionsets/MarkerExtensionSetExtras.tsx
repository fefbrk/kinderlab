...
// Import images
import MainImg from '@/assets/product/funextensionsets/markerextensionsetextras/Marker-Extras-600x398.jpeg';
import MarkerChainImg from '@/assets/product/funextensionsets/markerextensionsetextras/Marker-Extension-Set-Chain.jpeg';

const MarkerExtensionSetExtras = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '210');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '210');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Marker Extension Set - Extras added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '210');
    return product ? `$${product.price.toFixed(2)}` : '$39.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Marker Extension Set - Extras</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Marker Extension Set - Extras"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Marker Extension Set - Extras view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Marker Extension Set - Extras</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> MESEX210</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Attach more markers onto the Marker Extension Set and <strong>create longer “marker chains” with these extra arms and additional washable markers.</strong>
                </p>
                
                <p className="text-gray-700 mb-4">
                  <strong>The Marker Extension Set Extras includes:</strong>
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>4 arms</li>
                  <li>4 washable markers (colors may vary)</li>
                  Have more fun with the KIBO Marker Extension Set (sold separately) with these extras that extend to your oroginal set.
               
                </ul>
                
                <p className="text-gray-700">
                  <strong>Note:</strong> This is an add-on product to the KIBO Marker Extension Set. You must have a Marker Extension Set before you can use this add-on.
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.32 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Marker Extension Set - Extras - Enlarged"
...
export default MarkerExtensionSetExtras;