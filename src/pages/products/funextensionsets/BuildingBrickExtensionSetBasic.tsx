...
// Import images
import MainImg from '@/assets/product/funextensionsets/buildingbrickextenisonbasic/KIBO-120519_9267.jpg';
import SnowplowImg from '@/assets/product/funextensionsets/buildingbrickextenisonbasic/KIBO-snowplow.jpg';
import LegoImg from '@/assets/product/funextensionsets/buildingbrickextenisonbasic/Lego-2.jpg';

const BuildingBrickExtensionSetBasic = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '202');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '202');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Building Brick Extension Set (Basic) added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Building Brick Extension Set (Basic)</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Building Brick Extension Set (Basic)"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Building Brick Extension Set (Basic) view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Building Brick Extension Set (Basic)</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BBES202</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  The Basic Building Brick Extension Set includes four building brick bases that fit into the four module ports on KIBO’s body. Students can use one, two, three, or all four of these building brick bases to build fabulous structures onto their KIBO body, while mixing and matching any combination of Sensor Modules and brick bases.
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Building Brick Extension Set (Basic) - Enlarged"
...
export default BuildingBrickExtensionSetBasic;