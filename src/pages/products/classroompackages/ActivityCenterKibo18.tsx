...
// Import images
import MainImg from '@/assets/product/classroompackages/activitycenterkibo18/kibo-activity-center-4-6.jpg';
import KiboImg from '@/assets/product/classroompackages/activitycenterkibo18/KIBO-18-package-600x399.jpeg';
import CurriculumImg from '@/assets/product/classroompackages/activitycenterkibo18/curriculum-image.jpg';

const ActivityCenterKibo18 = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '107');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '107');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Activity Center KIBO 18 Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '107');
    return product ? `$${product.price.toFixed(2)}` : '$1975.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Activity Center KIBO 18 Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Activity Center KIBO 18 Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Activity Center KIBO 18 Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Activity Center KIBO 18 Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> ACP18</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
             <div className="prose max-w-none">
                ...
                <br></br><br></br>
                <p>The KIBO 18 Activity Center Package is designed to serve <strong>4 to 6 students</strong>, and is perfect for a makerspace, library or small classroom. This package includes:
</p>
              
              <br></br>
               <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>2 KIBO 18 kits</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">19.38 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Activity Center KIBO 18 Package - Enlarged"
...
export default ActivityCenterKibo18;