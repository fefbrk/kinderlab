...
// Import images
import MainImg from '@/assets/product/classroompackages/fullclassroomkibo21/KIBO-21-Full-e1658068632673-600x459.webp';
import KiboImg from '@/assets/product/classroompackages/fullclassroomkibo21/KIBO-120519_9358.jpg';
import CurriculumImg from '@/assets/product/classroompackages/fullclassroomkibo21/curriculum-image.jpg';

const FullClassroomKibo21 = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '106');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '106');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Full Classroom KIBO 21 Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '106');
    return product ? `$${product.price.toFixed(2)}` : '$9200.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Full Classroom KIBO 21 Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Full Classroom KIBO 21 Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Full Classroom KIBO 21 Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Full Classroom KIBO 21 Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> FCP21</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
               <div className="prose max-w-none">
                ...
                <br></br><br></br>
                <p>The KIBO 21 Full Classroom Package is designed to serve <strong>20 to 24 students with 10 KIBO 21 Robot Kits</strong>, and is perfect for a large classroom or for sharing within the school. This package includes:
</p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">98.86 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">18 × 28 × 40 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Full Classroom KIBO 21 Package - Enlarged"
...
export default FullClassroomKibo21;