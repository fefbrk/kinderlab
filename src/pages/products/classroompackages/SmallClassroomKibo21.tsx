...
// Import images
import MainImg from '@/assets/product/classroompackages/smallclassroomkibo21/KIBO-21-Small-600x600.webp';
import KiboImg from '@/assets/product/classroompackages/smallclassroomkibo21/KIBO-120519_9358-600x401.jpg';
import CurriculumImg from '@/assets/product/classroompackages/smallclassroomkibo21/curriculum-image.jpg';

const SmallClassroomKibo21 = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '105');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '105');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Small Classroom KIBO 21 Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '105');
    return product ? `$${product.price.toFixed(2)}` : '$4850.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Small Classroom KIBO 21 Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Small Classroom KIBO 21 Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Small Classroom KIBO 21 Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Small Classroom KIBO 21 Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> SCP21</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <br></br><br></br>
                <p>The KIBO 21 Small Classroom Package is designed to serve <strong>10 to 12 students with 5 KIBO 21 robot kits</strong>, and is perfect for a small classroom or sharing between classrooms. This package includes:
</p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">50.23 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Small Classroom KIBO 21 Package - Enlarged"
...
export default SmallClassroomKibo21;