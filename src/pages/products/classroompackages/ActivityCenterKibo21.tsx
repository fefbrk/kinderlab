...
// Import images
import MainImg from '@/assets/product/classroompackages/activitycenterkibo21/kibo-activity-center-4-6.jpg';
import KiboImg from '@/assets/product/classroompackages/activitycenterkibo21/KIBO-120519_9358.jpg';
import CurriculumImg from '@/assets/product/classroompackages/activitycenterkibo21/curriculum-image.jpg';

const ActivityCenterKibo21 = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '104');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '104');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Activity Center KIBO 21 Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '104');
    return product ? `$${product.price.toFixed(2)}` : '$2390.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Activity Center KIBO 21 Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Activity Center KIBO 21 Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Activity Center KIBO 21 Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Activity Center KIBO 21 Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> ACP21</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <br></br><br></br>
                <p>The KIBO 21 Activity Center Package is designed to serve <strong>4 to 6 students</strong> and is perfect for a makerspace, library or small classroom. This package includes:
</p>
              ...
              <br></br>
               <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  ...
                  <li>Creating with KIBO Core Curriculum</li>
                  <li>KIBO Activity Center Guidebook</li>
                  <li>Express Yourself! Expression Module Curriculum</li>
                  <li>Showtime With KIBO! Sound/Record Playback Module Curriculum</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">21.38 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">18 × 14 × 16 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Activity Center KIBO 21 Package - Enlarged"
...
export default ActivityCenterKibo21;