...
// Import images
import MainImg from '@/assets/product/classroompackages/activitycenterkibo21steam/STEAM-explorer-ACP-21.webp';
import KiboImg from '@/assets/product/classroompackages/activitycenterkibo21steam/KIBO-120519_9358.jpg';
import CurriculumImg from '@/assets/product/classroompackages/activitycenterkibo21steam/curriculum-image.jpg';

const ActivityCenterKibo21SteamExplorer = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '101');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '101');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Activity Center KIBO 21 STEAM Explorer Package added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '101');
    return product ? `$${product.price.toFixed(2)}` : '$3120.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Activity Center KIBO 21 STEAM Explorer Package</span>
        </nav>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Activity Center KIBO 21 STEAM Explorer Package"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Activity Center KIBO 21 STEAM Explorer Package view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Activity Center KIBO 21 STEAM Explorer Package</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> ACP21STEAM</div>
...
The KIBO 21 Activity Center Package is designed to serve <strong>4 to 6 students</strong> with 2 KIBO robots and is perfect for a makerspace, library or small classroom. This package includes:</p>
              
              <br></br>
               <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>2 KIBO 21 kits</li>
                  <li>2 Marker Extension Sets: integrate art and geometry by programming KIBO to draw</li>
                  <li>2 Building Brick Extension Sets: build with LEGO-compatible bricks to integrate engineering and imagination play</li>
                  <li>2 Free Throw Extension Sets: explore physics and measurement with a programmable throwing arm</li>
                  <li>2 Advanced Coding Extension Sets: extend into upper elementary coding concepts with new KIBO blocks</li>
                  <li>Pack of 6 Engineering Design Journals</li>
                  <li>Pack of 6 Assessment Workbooks</li>
                  ...
                  <li>KIBO Activity Center Guidebook</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">29 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">17 × 12 × 24 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Activity Center KIBO 21 STEAM Explorer Package - Enlarged"
...
export default ActivityCenterKibo21SteamExplorer;