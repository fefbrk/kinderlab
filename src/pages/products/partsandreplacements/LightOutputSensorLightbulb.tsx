...
// Import images
import MainImg from '@/assets/product/partsandreplacements/lightoutputsensorlightbulb/KIBO-120519_9233.jpg';
import CaveImg from '@/assets/product/partsandreplacements/lightoutputsensorlightbulb/KIBO-Cave-scaled-600x450.jpg';
import LightbulbImg from '@/assets/product/partsandreplacements/lightoutputsensorlightbulb/Lightbulb-with-Bowling.jpg';
import MultipleImg from '@/assets/product/partsandreplacements/lightoutputsensorlightbulb/Multiple-light-bulbs-600x430.png';

const LightOutputSensorLightbulb = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '313');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '313');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Light Output Sensor: Lightbulb added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Light Output Sensor: Lightbulb</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Light Output Sensor: Lightbulb"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Light Output Sensor: Lightbulb view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Light Output Sensor: Lightbulb</h1>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  Let KIBO shine! When used with the LIGHT ON wooden programming blocks, this Light Output (Lightbulb) sensor lights up KIBO for visual excitement.
                  <br></br><br></br> 
                  <p>Please be sure to order the LIGHT ON blocks for this sensor to function.</p>
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Light Output Sensor: Lightbulb - Enlarged"
...
export default LightOutputSensorLightbulb;