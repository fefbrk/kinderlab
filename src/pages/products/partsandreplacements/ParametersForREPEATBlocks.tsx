...
// Import images
import MainImg from '@/assets/product/partsandreplacements/parametersforrepeatblocks/Parameters-for-Repeat-Blocks.jpg';
import ProgramImg from '@/assets/product/partsandreplacements/parametersforrepeatblocks/KIBO-with-IF-program.jpg';

const ParametersForRepeatBlocks = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '318');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '318');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Parameters For REPEAT Blocks set added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '318');
    return product ? `$${product.price.toFixed(2)}` : '$34.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Parameters For REPEAT Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Parameters For REPEAT Blocks"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Parameters For REPEAT Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Parameters For REPEAT Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> PARAM-REPEAT</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  These parameter cards pair to the REPEAT conditional wooden programmable blocks which enhance young learners’ experiences with KIBO. With these parameters, children can perform repeat conditional commands as well as when working with the Distance Sensor (Telescope) and the Light Sensor (Eye) while programming with KIBO. These parameters include:
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  ...
                  <li>UNTIL DARK Parameter Card</li>
                  <li>UNTIL LIGHT Parameter Card</li>
                  <li>UNTIL FAR Parameter Card</li>
                  <li>UNTIL NEAR Parameter Card</li>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Parameters For REPEAT Blocks - Enlarged"
...
export default ParametersForRepeatBlocks;