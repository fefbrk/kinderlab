...
// Import images
import MainImg from '@/assets/product/partsandreplacements/clapsoundsensorear/KIBO-120519_9227-600x401.jpg';
import SecondImg from '@/assets/product/partsandreplacements/clapsoundsensorear/KIBO-120519_9228.jpg';
import CatImg from '@/assets/product/partsandreplacements/clapsoundsensorear/KIBO-Cat-600x401.jpg';

const ClapSoundSensorEar = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Clap Sound Sensor Ear added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '306');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Clap/Sound Sensor: Ear</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Clap/Sound Sensor: Ear view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Clap/Sound Sensor: Ear</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> SENSOR-SOUND</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  <strong>KIBO can hear!</strong> This clap/sound sensor (ear) allows KIBO to hear sounds. When using the WAIT FOR CLAP block, KIBO will wait for a child to clap in its “ear” before performing any other action.
                  <br></br><br></br> 
                  <p>Please be sure to also order the WAIT FOR CLAP block when ordering the ear sensor.</p>
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.24 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Clap/Sound Sensor: Ear - Enlarged"
...
export default ClapSoundSensorEar;