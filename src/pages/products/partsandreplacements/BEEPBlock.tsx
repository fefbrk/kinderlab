...
// Import images
import MainImg from '@/assets/product/partsandreplacements/beepblock/BLK-BEEP.jpg';
import ChildScanningImg from '@/assets/product/partsandreplacements/beepblock/Child-Scanning-scaled-600x800.jpg';
import GirlScanningImg from '@/assets/product/partsandreplacements/beepblock/Girl-Scanning-Sequence-600x737.jpg';
...
const BEEPBlock = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "BEEP Block added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '301');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">BEEP Block</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">BEEP Block</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-BEEP</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  This BEEP wooden programming block can be purchased to have KIBO beep when added to a student’s programming sequence.
                  <br></br><br></br> 
