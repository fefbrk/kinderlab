...
// Import images
import MainImg from '@/assets/product/partsandreplacements/stageartplatform/KIBO-120519_9148-600x400.jpg';
import SecondImg from '@/assets/product/partsandreplacements/stageartplatform/KIBO-120519_9255.jpg';
import DancerImg from '@/assets/product/partsandreplacements/stageartplatform/KIBO-Dancer-from-Africa-1-scaled-600x800.jpeg';
import RoverImg from '@/assets/product/partsandreplacements/stageartplatform/Space-Rover-scaled-600x401.jpg';

const StageArtPlatform = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '322');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '322');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Stage Art Platform added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '322');
    return product ? `$${product.price.toFixed(2)}` : '$38.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Stage Art Platform</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Stage Art Platform view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Stage Art Platform</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> STAGE-ART</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  The wonderful thing about KIBO is it can transform into anything. Incorporating arts and crafts onto KIBO’s art platforms, KIBO can become anything a child imagines – a research project on migrating whales, a re-enactment of a favorite storybook, a cultural dancer, exploring the solar system, and more!
                 
                
                </p>
                
                <p className="text-gray-700 mb-4">
                  The stage art platform for KIBO includes:
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Rectangular wooden art stage</li>
                  <li>Stage support</li>
                  <li>Spacer</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.48 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Stage Art Platform - Enlarged"
...
export default StageArtPlatform;