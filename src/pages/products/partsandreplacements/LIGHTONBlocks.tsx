...
// Import images
import MainImg from '@/assets/product/partsandreplacements/lightonblocks/KIBO-120519_9301.jpg';
import LightbulbImg from '@/assets/product/partsandreplacements/lightonblocks/Lightbulb-with-Bowling-600x402.jpg';
import MultipleImg from '@/assets/product/partsandreplacements/lightonblocks/Multiple-light-bulbs-600x430.png';
import ScienceImg from '@/assets/product/partsandreplacements/lightonblocks/Science-Cave-Exploring-1-600x450.jpg';
...
const LightOnBlocks = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '312');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '312');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "LIGHT ON Blocks set added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">LIGHT ON Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`LIGHT ON Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">LIGHT ON Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-LIGHTON</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 Let KIBO shine! When used with the Lightulb Output Sensor, these RED, WHITE, and BLUE blue wooden programming blocks KIBO lights up for visual excitement.
                  <br></br><br></br> 
                  <p>Please be sure to have the Light Output: Lightbulb sensor to use these Light On Blocks.</p>
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.56 lbs</td>
                      </tr>
                      <tr>
