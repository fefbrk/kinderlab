...
// Import images
import MainImg from '@/assets/product/partsandreplacements/motormodule/KIBO-120519_9220.jpg';
import SecondImg from '@/assets/product/partsandreplacements/motormodule/KIBO-120519_9222-600x401.jpg';
import ThirdImg from '@/assets/product/partsandreplacements/motormodule/KIBO-120519_9223-600x401.jpg';
import PreschoolImg from '@/assets/product/partsandreplacements/motormodule/Preschool-Girl-Programs-KIBO.jpg';
...
const MotorModule = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '316');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '316');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Motor Module added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '316');
    return product ? `$${product.price.toFixed(2)}` : '$50.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Motor Module</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Motor Module</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> MODULE-MOTOR</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  KIBO runs on motors. Not only do the motors get KIBO moving, but it can move the art platforms for some twirly fun!
                  <br></br><br></br> 
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.25 lbs</td>
                      </tr>
                      <tr>
