...
// Import images
import MainImg from '@/assets/product/partsandreplacements/forwardblock/KIBO-120519_9291.jpg';
import ChildImg from '@/assets/product/partsandreplacements/forwardblock/Child-Scanning-scaled-600x800.jpg';
import GirlImg from '@/assets/product/partsandreplacements/forwardblock/Girl-Scanning-Sequence-600x737.jpg';
...
const ForwardBlock = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "FORWARD Block added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '310');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">FORWARD Block</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`FORWARD Block view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">FORWARD Block</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-FORWARD</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  This FORWARD wooden programming block can be purchased to add more forward commands to a student’s programming sequence.
                  <br></br><br></br> 
