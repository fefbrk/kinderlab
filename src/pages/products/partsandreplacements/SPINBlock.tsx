...
// Import images
import MainImg from '@/assets/product/partsandreplacements/spinblock/Spin-Block.jpg';
import CarouselImg from '@/assets/product/partsandreplacements/spinblock/Carousel-600x800.jpg';
import DanceImg from '@/assets/product/partsandreplacements/spinblock/Dance-and-Movement-1.jpg';
import DancerImg from '@/assets/product/partsandreplacements/spinblock/Dancer-scaled.jpg';
...
const SpinBlock = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '321');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '321');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "SPIN Block added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">SPIN Block</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">SPIN Block</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-SPIN</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 Lets get dizzy! When children use the SPIN block as part of their programming sequence, KIBO will spin around. Have KIBO spin during a dance, or to spin a carousel!
