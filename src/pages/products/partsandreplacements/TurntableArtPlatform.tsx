...
// Import images
import MainImg from '@/assets/product/partsandreplacements/turntableartplatform/KIBO-120519_9139-600x401.jpg';
import SecondImg from '@/assets/product/partsandreplacements/turntableartplatform/KIBO-120519_9203-600x401.jpg';
import ThirdImg from '@/assets/product/partsandreplacements/turntableartplatform/KIBO-120519_9250.jpg';

const TurntableArtPlatform = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '325');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '325');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Turntable Art Platform added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '325');
    return product ? `$${product.price.toFixed(2)}` : '$85.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Turntable Art Platform</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Turntable Art Platform view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Turntable Art Platform</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> TURNTABLE-ART</div>
          ...
          <div className="py-8 min-h-[400px]">
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 The turntable art platform for KIBO includes:
                </p>
                
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>Round wooden art stage</li>
                  <li>Stage support</li>
                  <li>Motor</li>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.53 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Turntable Art Platform - Enlarged"
...
export default TurntableArtPlatform;