...
// Import images
import MainImg from '@/assets/product/partsandreplacements/singblock/KIBO-120519_9295.jpg';
import DancerImg from '@/assets/product/partsandreplacements/singblock/KIBO-Dancer-from-Africa-1-scaled-600x800.jpeg';
...
const SingBlock = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '320');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '320');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "SING Block added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">SING Block</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">SING Block</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-SING</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 KIBO sings! When children use the SING block as part of their programming sequence, KIBO will sing a little tune. They can add the SING block to enhance their code, to include a litty ditty!
