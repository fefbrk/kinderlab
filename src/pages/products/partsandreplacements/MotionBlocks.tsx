...
// Import images
import MainImg from '@/assets/product/partsandreplacements/motionblocks/KIBO-120519_9296.jpg';
import SidneyImg from '@/assets/product/partsandreplacements/motionblocks/sidney-permission-600x595.jpg';
import SpiderImg from '@/assets/product/partsandreplacements/motionblocks/Spider-with-blocks-scaled-600x450.jpg';
...
const MotionBlocks = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '315');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '315');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Motion Blocks set added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Motion Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Motion Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Motion Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-MOTION</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  The MOTION Wooden Programming Blocks get KIBO moving! The Motion Block set includes:
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>FORWARD Programming Block</li>
                  <li>BACKWARD Programming Block</li>
                  <li>TURN RIGHT Programming Block</li>
                  <li>TURN LEFT Programming Block</li>
                  <li>SHAKE Programming Block</li>
                </ul>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.94 lbs</td>
                      </tr>
                      <tr>
