...
// Import images
import MainImg from '@/assets/product/partsandreplacements/conditionalblocks/KIBO-120519_9293.jpg';
import SensorImg from '@/assets/product/partsandreplacements/conditionalblocks/Putting-in-a-Sensor-600x400.jpg';
import usingSensorImg from '@/assets/product/partsandreplacements/conditionalblocks/Using-Sensors-scaled-600x800.jpg';
import SensorBuildImg from '@/assets/product/partsandreplacements/conditionalblocks/Sensor-Build-e1658103076337-600x222.jpg';
...
const ConditionalBlocks = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Conditional Blocks added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '307');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Conditional Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Conditional Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Conditional Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-CONDITIONAL</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 These conditional blocks enhance young learners’ experiences with KIBO by allowing them to perform repeat loops or conditional commands to accompany the many sensors while programming KIBO – Clap Sound Sensor (Ear) Sensor, Light Sensor (Eye), Distance Sensor (Telescope). The conditional blocks package includes:
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>1 WAIT FOR CLAP Programming Block</li>
                  <li>1 REPEAT Programming Block  </li>
                  <li>1 END REPEAT Programming Block</li>
                  <li>1 IF Programming Block</li>
                  <li>1 END IF Programming Block</li>
                </ul>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">1.14 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">8.8 × 6.5 × 3.75 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Conditional Blocks - Enlarged"
