...
// Import images
import MainImg from '@/assets/product/partsandreplacements/distancesensortelescope/KIBO-120519_9235-600x401.jpg';
import SecondImg from '@/assets/product/partsandreplacements/distancesensortelescope/KIBO-120519_9236.jpg';
import PhotoImg from '@/assets/product/partsandreplacements/distancesensortelescope/KIBO-Photo-600x288.jpg';
import SensorImg from '@/assets/product/partsandreplacements/distancesensortelescope/Putting-in-a-Sensor.jpg';

const DistanceSensorTelescope = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Distance Sensor Telescope added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '308');
    return product ? `$${product.price.toFixed(2)}` : '$46.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Distance Sensor: Telescope</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Distance Sensor: Telescope view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Distance Sensor: Telescope</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> SENSOR-DISTANCE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 KIBO detects distance! This distance sensor (telescope) allows KIBO to know near and far! When using the “IF/THEN” conditional blocks, along with the parameter cards – “Near”, “Far”, “Until Near” and “Until Far” – KIBO will know how far it is from an object. Don’t let KIBO bump into the wall!
                  <br></br><br></br> 
                  <p>Please be sure to order the IF/THEN Conditional Blocks and parameters cards  to take advantage of the telescope sensor!</p>
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.23 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Distance Sensor: Telescope - Enlarged"
...
export default DistanceSensorTelescope;