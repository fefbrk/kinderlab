...
// Import images
import MainImg from '@/assets/product/partsandreplacements/firmwareupdatecable/cable-wound.webp';
import ConnectedImg from '@/assets/product/partsandreplacements/firmwareupdatecable/mac-01-kibo-connected.webp';

const FirmwareUpdateCable = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '309');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '309');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Firmware Update Cable added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Firmware Update Cable</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Firmware Update Cable view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Firmware Update Cable</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> CABLE-FIRMWARE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  This cable is available to purchase should you need to update your KIBO whenever there is a firmware update. This cable is also included in any kit, but you can order a replacement as needed.
                  <br></br><br></br> 
                  <p>Note: This is a standard USB-A cable; any compatible cable will work to apply a KIBO firmware update.</p>
                </p>
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.04 lbs</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium text-gray-900 bg-gray-100 w-1/3">Dimensions</td>
                        <td className="px-6 py-4 text-gray-700 w-2/3">6 × 4 × 0.5 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Firmware Update Cable - Enlarged"
...
export default FirmwareUpdateCable;