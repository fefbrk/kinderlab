...
// Import images
import MainImg from '@/assets/product/partsandreplacements/lightsensoreye/KIBO-120519_9225-600x401.jpg';
import SecondImg from '@/assets/product/partsandreplacements/lightsensoreye/KIBO-120519_9226.jpg';
import BoatImg from '@/assets/product/partsandreplacements/lightsensoreye/kibo-boat-600x448.jpg';
import ProgramImg from '@/assets/product/partsandreplacements/lightsensoreye/KIBO-with-IF-program-600x498.jpg';

const LightSensorEye = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '314');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '314');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Light Sensor: Eye added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Light Sensor: Eye</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Light Sensor: Eye view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Light Sensor: Eye</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> SENSOR-LIGHT-EYE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 KIBO can detect light! This Light sensor (eye) allows KIBO to judge light and dark.
                  <br></br><br></br> 
                  <p>This sensor requires the Conditional Blocks (REPEAT and IF) and applicable parameter cards to function. Please be sure to order those if you don’t have them already!</p>
                </p>
