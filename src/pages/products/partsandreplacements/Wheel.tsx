...
// Import images
import MainImg from '@/assets/product/partsandreplacements/wheel/KIBO-120519_9221.jpg';
import SecondImg from '@/assets/product/partsandreplacements/wheel/KIBO-120519_9222.jpg';
import ThirdImg from '@/assets/product/partsandreplacements/wheel/KIBO-120519_9224.jpg';
import WallImg from '@/assets/product/partsandreplacements/wheel/KIBO-and-Wall-1-scaled-600x450.jpg';
...
const Wheel = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '327');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '327');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Wheel added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Wheel</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Wheel</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> WHEEL</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  If you want your KIBO to move, add on some wheels! The wheels, when attached to their motors, allow KIBO to perform any of the movements found in that wooden programming block set. And there are two ways for KIBO to move – a smooth ride or a hop-along – depending on how you insert the motors. Zoom! Zoom!
                  <br></br><br></br> 
