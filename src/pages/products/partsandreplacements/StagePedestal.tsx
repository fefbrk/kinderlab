...
// Import images
import MainImg from '@/assets/product/partsandreplacements/stagepedestal/KIBO-120519_9246.jpg';
import SecondImg from '@/assets/product/partsandreplacements/stagepedestal/KIBO-120519_9248-600x401.jpg';
import ThirdImg from '@/assets/product/partsandreplacements/stagepedestal/KIBO-120519_9255-600x400.jpg';
...
const StagePedestal = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '323');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '323');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Stage Pedestal added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Stage Pedestal</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Stage Pedestal view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Stage Pedestal</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> STAGE-PEDESTAL</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 This Stage Pedestal connects KIBO’s art stage platforms to the motor or Stage Support. With the ability to decorate KIBO, children can turn KIBO into anything they want it to be!
