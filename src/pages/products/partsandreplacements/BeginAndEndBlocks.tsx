...
// Import images
import MainImg from '@/assets/product/partsandreplacements/beginandendblocks/KIBO-120519_9290.jpg';

const BeginAndEndBlocks = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Begin and End Blocks added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '302');
    return product ? `$${product.price.toFixed(2)}` : '$16.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">BEGIN And END Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`BEGIN And END Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">BEGIN And END Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> BLK-BEGIN-END</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 <strong>Like every story, KIBO needs a beginning and and ending to perform its programming story.</strong> Students will use the BEGIN and END blocks to begn and end their programming sequence.
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">0.41 lbs</td>
                      </tr>
                      <tr>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="BEGIN And END Blocks - Enlarged"
...
export default BeginAndEndBlocks;