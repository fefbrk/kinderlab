...
// Import images
import MainImg from '@/assets/product/partsandreplacements/blockstickerupgrade/KIBO-120519_9296.jpg';
import StickerUpgradeImg from '@/assets/product/partsandreplacements/blockstickerupgrade/Sticker-Upgrade-600x590.jpg';

const BlockStickerUpgrade = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Block Sticker Upgrade added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '303');
    return product ? `$${product.price.toFixed(2)}` : '$2.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Block Sticker Upgrade</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Block Sticker Upgrade view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Block Sticker Upgrade</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> STICKER-UPGRADE</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 Through continued research and development, we have improved the KIBO programming block labels to make them easier to scan. All kits sold after November 1, 2017, include the new blocks, but we wanted to make it possible to upgrade the blocks in the older kits.
                  <br></br><br></br> 
                  <p>To purchase, enter the number of <strong>blocks</strong> you want to upgrade in the “Quantity” field, and add those to your cart. Then, <strong>in the Special Instructions field during checkout, list the blocks you want to upgrade</strong> so that we know which stickers to send you.</p>
                </p>
                
                <p className="text-gray-700 mb-4">
                  ** For orders within the US, there is no shipping cost for this item. For orders outside the US, we may contact you for an additional shipping charge. **
                </p>
                
              
                
                <p className="text-gray-700">
                 Note: this item lets you pick individual blocks to upgrade. But if you’re looking to upgrade all the blocks in an entire KIBO kit, a simpler choice is our Block Sticker Upgrade Pack. These are pre-configured sets of stickers and parameters to upgrade a whole KIBO 10, KIBO 14, KIBO 18, or KIBO 21 robot kit.
                </p>
              </div>
            )}
                  ...
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-gray-700 w-2/3">4 × 4 × 1 in</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Block Sticker Upgrade - Enlarged"
...
export default BlockStickerUpgrade;