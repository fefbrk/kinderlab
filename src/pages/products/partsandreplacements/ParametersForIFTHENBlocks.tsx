...
// Import images
import MainImg from '@/assets/product/partsandreplacements/parametersforifthenblocks/If-Then-Parameters-600x547.jpg';
import ProgramImg from '@/assets/product/partsandreplacements/parametersforifthenblocks/KIBO-with-IF-program-600x498.jpg';

const ParametersForIfThenBlocks = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '317');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '317');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Parameters For IF/THEN Blocks set added to your cart.",
    });
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Parameters For IF/THEN Blocks</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Parameters For IF/THEN Blocks"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Parameters For IF/THEN Blocks view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Parameters For IF/THEN Blocks</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> PARAM-IFTHEN</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                  These parameter cards pair to the IF/THEN conditional wooden programmable blocks which enhance young learners’ experiences with KIBO. With these parameters, children can perform conditional commands which accompany the Distance Sensor (Telescope) and the Light Sensor (Eye) while programming KIBO. These parameters include:
                
                 
                </p>
                
                  <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>DARK Parameter Card</li>
                  <li>LIGHT Parameter Card</li>
                  <li>NEAR Parameter Card</li>
                  <li>FAR Parameter Card</li>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Parameters For IF/THEN Blocks - Enlarged"
...
export default ParametersForIfThenBlocks;