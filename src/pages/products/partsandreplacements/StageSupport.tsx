...
// Import images
import MainImg from '@/assets/product/partsandreplacements/stagesupport/KIBO-120519_9242.jpg';
import SecondImg from '@/assets/product/partsandreplacements/stagesupport/KIBO-120519_9255.jpg';
import WhiteboardImg from '@/assets/product/partsandreplacements/stagesupport/I-love-KIBO-Whiteboard.jpg';
...
const StageSupport = () => {
  ...
  const productInCart = cartItems.find(item => item.id === '324');
  ...
  const handleAddToCart = () => {
    const product = products.find(p => p.id === '324');
    if (product) {
      addToCart(product);
      setJustAdded(true);
    ...
    toast({
      title: "Added to cart",
      description: "Stage Support added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '324');
    return product ? `$${product.price.toFixed(2)}` : '$10.00';
  };
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Stage Support</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Stage Support view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Stage Support</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> STAGE-SUPPORT</div>
            ...
            {activeTab === 'description' && (
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 This stage support connects KIBO’s art stages or Expression Module flagpole to KIBO. With this support, just imagine the creations a child can build onto their KIBO!
