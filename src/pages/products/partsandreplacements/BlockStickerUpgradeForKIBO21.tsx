...
// Import images
import MainImg from '@/assets/product/partsandreplacements/blockstickerupgradeforkibo21/Sticker-Upgrade-600x590.jpg';

const BlockStickerUpgradeForKIBO21 = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast({
      title: "Added to cart",
      description: "Block Sticker Upgrade for KIBO 21 added to your cart.",
    });
  };

  const getPrice = () => {
    const product = products.find(p => p.id === '305');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-kibo-purple font-medium">Block Sticker Upgrade For KIBO 21</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Main Image */}
             <div className="relative bg-white border rounded-lg overflow-hidden group">
               ...
               <img
                 ...
                 alt="Block Sticker Upgrade For KIBO 21"
            ...
            <div className="flex space-x-2">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Block Sticker Upgrade For KIBO 21 view ${index + 1}`}
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-kibo-purple mb-4">Block Sticker Upgrade For KIBO 21</h1>
            ...
            <div className="text-sm text-gray-500 space-y-1">
              <div><span className="font-medium">SKU:</span> STICKER-UPGRADE-21</div>
              ...
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-4">
                 Through continued research and development, we have improved the KIBO programming block labels to make them easier to scan. All kits sold after November 1, 2017, include the new blocks, but we wanted to make it possible to upgrade the blocks in the older kits.
                  <br></br><br></br> 
                  <p>The Block Sticker Upgrade Pack for KIBO 21 includes all the individual block label stickers and parameter cards needed to upgrade a KIBO 21 robot kit with the new stickers.</p>
                </p>
       ...
       {isModalOpen && (
         <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" onClick={() => setIsModalOpen(false)}>
           <div className="relative max-w-4xl max-h-[90vh] p-4">
             ...
             <img
                src={images[selectedImage]}
                alt="Block Sticker Upgrade For KIBO 21 - Enlarged"
...
export default BlockStickerUpgradeForKIBO21;